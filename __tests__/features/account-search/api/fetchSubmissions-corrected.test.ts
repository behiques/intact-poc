...
describe('fetchSubmissions', () => {
  ...
  describe('Error Handling', () => {
    ...
    it('should handle authentication errors', async () => {
      ...
      await expect(fetchSubmissions()).rejects.toThrow(
        'Failed to fetch submissions: Authentication failed or session expired while fetching submissions'
      )
    ...
    it('should handle validation errors', async () => {
      ...
      await expect(fetchSubmissions()).rejects.toThrow(
        'Failed to fetch submissions: Invalid request parameters or malformed data while fetching submissions'
      )
    ...
    it('should handle server errors', async () => {
      ...
      await expect(fetchSubmissions()).rejects.toThrow(
        'Failed to fetch submissions: Internal server error while fetching submissions'
      )
    ...
    it('should handle rate limiting errors', async () => {
      ...
      await expect(fetchSubmissions()).rejects.toThrow(
        'Failed to fetch submissions: Rate limit exceeded while fetching submissions'
      )
